...
class CNN1DModel(nn.Module):
    def __init__(self, in_shape: int, out_shape: int, hidden_units: int, signal_length: int):
        ...
        nn.ReLU(),
        nn.Conv1d(in_channels=in_shape, out_channels=hidden_units*2, kernel_size = kernel_size, stride=stride, padding=padding),
        nn.ReLU(),
        nn.Conv1d(in_channels=in_shape, out_channels=hidden_units*4, kernel_size = kernel_size, stride=stride, padding=padding),
        nn.ReLU(),
        nn.Conv1d(in_channels=in_shape, out_channels=hidden_units*8, kernel_size = kernel_size, stride=stride, padding=padding),
        nn.ReLU(),
        nn.Flatten(),
